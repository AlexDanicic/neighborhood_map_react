...
export class MapContainer extends React.Component {
    ...
    getMarkerInfo(marker) {
        ...
        const clientId = "X3JNVJLZXNZ2EUHLJ0MMRJ2MDJ3ZTJ5MUBNS3VYAWV3M0IQV";
        const clientSecret = "LXKFDLL3DLP14TL53HG00LOISB3ZZRUWU0RPEYZMHF4O2YCM";
...
export default GoogleApiWrapper({
  apiKey: 'AIzaSyCIoQ-s2-LKRcgSUjukDnNXv7jL_7hjuh4',
  script:'async'
})(MapContainer)
